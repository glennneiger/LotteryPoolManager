...
public class ShowContactsAndEmailPBTickets extends ListActivity {
	...
	public OnClickListener addContactListener = new OnClickListener() {
		...
		public void onClick(View v) {
			Intent intent = new Intent(ShowContactsAndEmailPBTickets.this, EnterContacts.class);
	...
	public OnClickListener emailContactsListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			emailIntent.putExtra(Intent.EXTRA_SUBJECT,
					"Powerball tickets for upcoming drawing");
			...
			try {
				...
				Toast.makeText(ShowContactsAndEmailPBTickets.this,
	...
	public OnClickListener deleteContactsListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			AlertDialog.Builder builder = new AlertDialog.Builder(
					ShowContactsAndEmailPBTickets.this);
