...
public class EmailMMResults extends ListActivity{
	...
	public OnClickListener addContactListener = new OnClickListener() {
		...
		public void onClick(View v) {
			Intent intent = new Intent(EmailMMResults.this, EnterContacts.class);
	...
	public OnClickListener emailContactsListener = new OnClickListener() {
		...
		public void onClick(View v) {
			...
			emailIntent.putExtra(Intent.EXTRA_SUBJECT,
					"Mega Millions results from last drawing");
			...
			if (winningTickets == 0) {
				...
				for (MegaMillionsTickets ticket : mmTickets) {
					...
					if (ticket.getMatchingRegularNumbers() == 5 && ticket.isMegaballMatch()) {
						emailTextBuilder.append("<br><pre>5 out of 5 numbers - with megaball" 
							+ " <br><b>" + ticket.toString() + "(MB)</b></pre>");
					}
					if (ticket.getMatchingRegularNumbers() == 5 && !ticket.isMegaballMatch()) {
						emailTextBuilder.append("<br/><pre>5 out of 5 numbers - no megaball" 
							+ " <br><b>" + ticket.toString() + "(MB)</b></pre>");
					}
					if (ticket.getMatchingRegularNumbers() == 4 && ticket.isMegaballMatch()) {
						emailTextBuilder.append("<br/><pre>4 out of 5 numbers - with megaball" 
							+ " <br><b>" + ticket.toString() + "(MB)</b></pre>");
					}
					if (ticket.getMatchingRegularNumbers() == 4 && !ticket.isMegaballMatch()) {
						emailTextBuilder.append("<br/><pre>4 out of 5 numbers - no megaball" 
							+ " <br><b>" + ticket.toString() + "(MB)</b></pre>");
					}
					if (ticket.getMatchingRegularNumbers() == 3 && ticket.isMegaballMatch()) {
						emailTextBuilder.append("<br/><pre>3 out of 5 numbers - with megaball" 
							+ " <br><b>" + ticket.toString() + "(MB)</b></pre>");
					}
					if (ticket.getMatchingRegularNumbers() == 3 && !ticket.isMegaballMatch()) {
						emailTextBuilder.append("<br/><pre>3 out of 5 numbers - no megaball" 
							+ " <br><b>" + ticket.toString() + "(MB)</b></pre>");
					}
					if (ticket.getMatchingRegularNumbers() == 2 && ticket.isMegaballMatch()) {
						emailTextBuilder.append("<br/><pre>2 out of 5 numbers - with megaball" 
							+ " <br><b>" + ticket.toString() + "(MB)</b></pre>");
					}
					if (ticket.getMatchingRegularNumbers() == 1 && ticket.isMegaballMatch()) {
						emailTextBuilder.append("<br/><pre>1 out of 5 numbers - with megaball" 
							+ " <br><b>" + ticket.toString() + "(MB)</b></pre>");
					}
					if (ticket.getMatchingRegularNumbers() == 0 && ticket.isMegaballMatch()) {
						emailTextBuilder.append("<br/><pre>0 out of 5 numbers - with megaball" 
							+ " <br><b>" + ticket.toString() + "(MB)</b></pre>");
					}
			...
			try {
				...
				Toast.makeText(EmailMMResults.this,
